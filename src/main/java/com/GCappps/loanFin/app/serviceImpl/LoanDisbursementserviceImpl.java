...
public class LoanDisbursementserviceImpl implements LoanDisbursementserviceI {
	...
	public LoanDisbursement loandisbursement(Customer customer) {
		...
		String content1="as per your vehicle quotation provided to "+customer.getCustomerFirstName()+" "+customer.getCustomerLastName()+
				"and further loan application is approved of amount"+customer.getSanctionLetter().getLoanAmountSanctioned()+
				"is sanctioned by GCappps and amount is disbursed into your account"+" "+customer.getDealerData().getAccountNumber();
